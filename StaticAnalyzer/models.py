...
class SO_AND_SDK(models.Model):
    SO_NAME = models.CharField(max_length=128)
    SDK_NAME = models.CharField(max_length=128)
    CN_NAME = models.CharField(max_length=128)
    CONTENT = models.CharField(max_length=1024,null=True)
    WEBADDRESS = models.CharField(max_length=512,null=True)
